...
export const AllCalls = ({ activities, fetchActivities }) => {
  const [activeCall, setActiveCall] = useState("");
  const [nonArchivedCalls, setNonArchivedCalls] = React.useState([]);
  const [openSnackbar, setOpenSnackbar] = React.useState(false);

  console.log("activeCall", activeCall);

  const handleArchive = (activity) => {
